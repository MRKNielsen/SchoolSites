...
\newcommand{\anslines}[1]{%
  \vspace{2pt}%
  \foreach \n in {1,...,#1}{%
    \par\noindent\rule{\linewidth}{0.3pt}\vspace{13pt}%
  }%
}
...
\question{1.1}{2}{Use the table to state the diameter of Earth and the diameter of the Sun.}
\anslines{2}

\question{1.2}{2}{Calculate how many times wider the Sun is than Earth. Show your working and give your answer to the nearest whole number.}
\anslines{3}

\question{1.3}{2}{The Moon is 384,400 km from Earth. Calculate how many Earth diameters would fit into that gap.}
\anslines{3}

\question{1.4}{2}{In the tennis-ball model, Earth is 6.7 cm across and the Sun sits 807 m down the road. Explain what this model shows that the table of diameters alone does not.}
\anslines{3}
...
\begin{tikzpicture}[
    ...
    lead/.style={draw=Grey, line width=0.6pt, -{Stealth[length=4.5pt,width=3.5pt]}},
  ...
  \draw[lead] (4.25,3.25)  -- (1.72,3.15);
  \draw[lead] (4.25,1.95)  -- (1.95,2.15);
...
\question{1.5}{2}{Name Earth's four main layers in order, starting from the centre.}
\anslines{2}

\question{1.6}{2}{Which layer generates Earth's magnetic field, and what is this process called?}
\anslines{2}

\question{1.7}{2}{The mantle is described as semi-solid rock. State its thickness and what its convection currents drive.}
\anslines{2}

\question{1.8}{2}{Compare oceanic and continental crust using two differences given in the booklet.}
\anslines{3}
...
\question{1.9}{2}{Define nuclear fusion as it occurs in the Sun.}
\anslines{2}

\question{1.10}{2}{List the layers of the Sun in order, starting at the core.}
\anslines{2}

\question{1.11}{2}{State the temperature of the Sun's core and of its photosphere.}
\anslines{2}

\question{1.12}{3}{Jupiter is 5.20 AU from the Sun. Sunlight reaches Earth (1 AU) in 500 seconds. Calculate how long sunlight takes to reach Jupiter, in minutes and seconds.}
\anslines{4}
...
\question{2.1}{2}{State how long Earth takes to rotate once on its axis, and how long it takes to revolve once around the Sun.}
\anslines{2}

\question{2.2}{2}{Explain why the Sun appears to rise in the east and set in the west.}
\anslines{3}
...
\question{2.3}{1}{State the size of Earth's axial tilt.}
\anslines{1}

\question{2.4}{2}{Describe two effects of the Southern Hemisphere being tilted toward the Sun in December.}
\anslines{3}

\question{2.5}{3}{Earth is actually closest to the Sun in January. Explain why this is \textit{not} the cause of Australian summer.}
\anslines{4}
...
\question{2.6}{2}{Using the table, state the date of the Australian summer solstice and what happens on that day.}
\anslines{2}

\question{2.7}{2}{State what is equal at an equinox, and name the Australian season that begins at the March equinox.}
\anslines{2}
...
\question{2.8}{1}{State how long the Moon takes to complete one full cycle of phases.}
\anslines{1}

\question{2.9}{3}{Explain why the Moon appears to change shape over a month.}
\anslines{4}

\question{2.10}{2}{A student writes: ``The phases of the Moon are caused by Earth's shadow falling on it.'' Correct this statement.}
\anslines{3}
...
\question{2.11}{1}{State what causes the tidal bulge on the side of Earth facing the Moon.}
\anslines{1}

\question{2.12}{3}{Explain the difference between spring tides and neap tides, including when each occurs.}
\anslines{4}
...
\question{3.1}{2}{Using the table, name the four terrestrial planets.}
\anslines{2}

\question{3.2}{1}{Which planet has the most moons, and how many does it have?}
\anslines{1}

\question{3.3}{1}{State the type given in the table for Uranus and Neptune.}
\anslines{1}

\question{3.4}{2}{Convert Jupiter's distance from the Sun (5.20 AU) into kilometres.}
\anslines{3}

\question{3.5}{2}{Calculate how many times farther from the Sun Neptune is than Earth.}
\anslines{2}

\question{3.6}{3}{Compare the terrestrial planets with the gas giants, using two pieces of evidence from the table.}
\anslines{4}
...
\question{3.7}{1}{State where the asteroid belt is located.}
\anslines{1}

\question{3.8}{2}{Explain why the objects in the asteroid belt never formed into a planet.}
\anslines{2}

\question{3.9}{1}{State the distance range of the Kuiper Belt in AU.}
\anslines{1}

\question{3.10}{3}{Name two dwarf planets and state the two reasons they are not classified as planets.}
\anslines{3}

\question{3.11}{2}{Describe what happens to a comet as it approaches the Sun.}
\anslines{2}
...
\question{4.1}{3}{Write Newton's law of universal gravitation and state what each symbol represents.}
\anslines{4}

\question{4.2}{1}{State what happens to the gravitational force between two objects if one of the masses is doubled.}
\anslines{1}

\question{4.3}{2}{Explain what happens to the gravitational force if the distance between two objects is doubled, and name this relationship.}
\anslines{2}

\question{4.4}{1}{A student claims gravity can push objects apart. Explain why this is incorrect.}
\anslines{2}
...
\question{4.5}{2}{Define an orbit, referring to gravity and centripetal force.}
\anslines{2}

\question{4.6}{3}{Explain why an object in orbit is described as being in constant free fall.}
\anslines{3}

\question{4.7}{2}{State the approximate altitude of the ISS and the strength of gravity there as a percentage of its strength at Earth's surface.}
\anslines{2}

\question{4.8}{2}{A student says astronauts float on the ISS because there is no gravity in space. Correct this statement.}
\anslines{3}
...
\question{4.9}{2}{Using the table, state the orbital speed and period of the ISS.}
\anslines{2}

\question{4.10}{2}{Describe the relationship between orbital altitude and orbital speed shown in the table.}
\anslines{2}

\question{4.11}{2}{Explain why a satellite in geostationary orbit appears to stay in the same place in the sky.}
\anslines{3}

\question{4.12}{2}{GPS satellites operate in MEO. Using the table, state the altitude range and orbital period of this orbit.}
\anslines{2}
...
\question{5.1}{2}{Define a light-year and state what type of quantity it measures.}
\anslines{2}

\question{5.2}{2}{Proxima Centauri is 4.2 light-years away. Explain what we are actually seeing when we look at it tonight.}
\anslines{3}
...
\question{5.3}{2}{Using the table, state the spectral class and colour of the Sun.}
\anslines{2}

\question{5.4}{3}{Arrange Rigel, the Sun and Proxima Centauri in order of decreasing surface temperature, justifying your order with data from the table.}
\anslines{3}
...
\question{5.5}{2}{List, in order, the stages in the life cycle of a Sun-like star.}
\anslines{2}

\question{5.6}{2}{State how the life cycle of a star more massive than 8 solar masses differs after the main sequence.}
\anslines{3}
...
\question{5.7}{2}{State one property all electromagnetic waves share, and two properties that differ between them.}
\anslines{2}

\question{5.8}{2}{Using the table, name the region of the spectrum used to study black holes, and the region used to map galaxies with the SKA.}
\anslines{2}
...
\question{5.9}{2}{Explain the difference between a refracting and a reflecting telescope.}
\anslines{3}

\question{5.10}{2}{Give two reasons for placing a telescope in space rather than on the ground.}
\anslines{2}
...
\question{5.11}{3}{Explain how absorption lines allow astronomers to identify the elements present in a star.}
\anslines{4}

\question{5.12}{1}{A star's spectral lines are redshifted. State what this tells you about its motion.}
\anslines{1}
...
\question{6.1}{2}{Explain how a dark constellation differs from a Western constellation.}
\anslines{3}

\question{6.2}{2}{Name the nebula that forms the head of the Emu in the Sky, and the constellation it lies near.}
\anslines{2}

\question{6.3}{3}{Explain what the dark lanes of the Milky Way actually are, and why they are scientifically significant.}
\anslines{3}

\question{6.4}{2}{Describe the ecological information encoded by the position of the Emu in the Sky in autumn.}
\anslines{3}
...
\question{6.5}{3}{State how many celestial objects were documented in the Boorong catalogue, in what year, and by whom.}
\anslines{3}

\question{6.6}{2}{Name two types of celestial object recorded in the Boorong catalogue.}
\anslines{2}

\question{6.7}{1}{State the Boorong name for the Magellanic Clouds.}
\anslines{1}

\question{6.8}{3}{Explain why the Boorong record of the Eta Carinae brightening is scientifically significant.}
\anslines{4}
...
\question{6.9}{2}{Explain what the rising of the Pleiades signals on Wurundjeri Country.}
\anslines{2}

\question{6.10}{3}{Describe two ways the six-season Kulin calendar differs from the European four-season model.}
\anslines{4}

\question{6.11}{3}{Evaluate the claim that Aboriginal astronomy is a science. Use one specific piece of evidence from this lesson.}
\anslines{4}
...
\question{7.1}{2}{Using the table, state the year of Sputnik 1 and its significance.}
\anslines{2}

\question{7.2}{2}{Identify the two missions in the table launched to investigate habitability, and state which bodies they target.}
\anslines{2}
...
\question{7.3}{2}{Explain the role the Parkes Radio Telescope played in the Apollo 11 mission.}
\anslines{2}

\question{7.4}{1}{State the everyday technology CSIRO developed out of its radio astronomy research.}
\anslines{1}

\question{7.5}{2}{State where the core of the Square Kilometre Array is being built, and give one reason that site was chosen.}
\anslines{2}
...
\question{7.6}{1}{State the approximate number of tracked debris objects larger than 10 cm.}
\anslines{1}

\question{7.7}{3}{Explain why a fragment only 1 cm across is dangerous to a spacecraft.}
\anslines{3}
...
\question{7.8}{3}{Define Kessler syndrome.}
\anslines{3}

\question{7.9}{2}{State the evidence given in the booklet that this cascade risk is real.}
\anslines{2}
...
\question{7.10}{3}{Name three distinct uses of Earth observation satellites given in the booklet.}
\anslines{3}

\question{7.11}{2}{Explain why weather forecasts beyond 24 hours depend on satellites.}
\anslines{2}

\question{7.12}{2}{State the accuracy of GPS positioning and name two sectors that depend on it.}
\anslines{2}
...
\question{8.1}{2}{List the four requirements for life as we know it.}
\anslines{2}

\question{8.2}{2}{Explain why carbon is uniquely suited to the chemistry of life.}
\anslines{3}
...
\question{8.3}{2}{Define the habitable zone and state where Earth and Mars sit relative to it.}
\anslines{2}

\question{8.4}{3}{Explain how tidal heating allows liquid water to exist far outside the classical habitable zone.}
\anslines{3}
...
\question{8.5}{2}{State two pieces of evidence that Mars once had liquid water.}
\anslines{2}

\question{8.6}{3}{Describe the structure of Europa that makes it a high-priority astrobiology target.}
\anslines{4}

\question{8.7}{3}{State what Cassini detected in the plume of Enceladus, and explain why this matters for the search for life.}
\anslines{3}
...
\question{8.8}{3}{Define ``extremophile'' and give two examples of the extreme conditions they tolerate.}
\anslines{3}

\question{8.9}{2}{Explain how the discovery of extremophiles changed where scientists search for life beyond Earth.}
\anslines{3}
...
\question{8.10}{1}{State approximately how many exoplanets had been confirmed by 2024.}
\anslines{1}

\question{8.11}{3}{Explain the transit method of exoplanet detection and state what it reveals about the planet.}
\anslines{4}

\question{8.12}{3}{Explain why oxygen and methane detected together are considered a strong biosignature.}
\anslines{4}
...
\toprule
\textbf{Lesson} & \textbf{VC 2.0 Content Description} \\
\midrule
1 & \textit{Earth and Space Sciences} --- Investigate and model the relative scales of the solar system including the sizes of and distances between objects \\
2 & \textit{Earth and Space Sciences} --- Explain how the gravitational attraction between the Moon and Earth causes tides, and how Earth's orbit around the Sun and Moon's orbit around Earth lead to predictable patterns including phases, eclipses and seasons \\
3 & \textit{Earth and Space Sciences} --- Investigate the structure and scale of the solar system and compare features of planets, moons, asteroids and comets \\
4 & \textit{Physical Sciences} --- Analyse how gravity acts on objects in the solar system and describe the relationship between gravitational force, mass and distance \\
5 & \textit{Earth and Space Sciences / Physical Sciences} --- Analyse properties of stars and galaxies using data from telescopes and space missions; investigate properties of light and the electromagnetic spectrum, including how different telescopes detect different types of radiation \\
6 & \textit{Cross-curriculum: Aboriginal and Torres Strait Islander histories and cultures} --- Explore Indigenous astronomical knowledge and knowledge systems as a form of science \\
7 & \textit{Science as a Human Endeavour} --- Explain how science and technology have contributed to advances in space exploration and satellite technologies, and evaluate their social, ethical and environmental impacts \\
8 & \textit{Earth and Space Sciences / Biological Sciences} --- Investigate the conditions required for life and evaluate the likelihood of life existing elsewhere in the universe \\
\bottomrule
\end{tabularx}
\end{center}
