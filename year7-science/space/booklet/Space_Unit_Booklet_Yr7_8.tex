...
\begin{center}
  ...
  \vspace{0.8cm}
  {\headingfont\fontsize{18pt}{22pt}\selectfont\color{SpaceMid}
    Student Workbook}
  ...
  \vspace{1.6cm}
  % Ten sections, one per lesson — keep this list in step with the
  % \section headings below and with the unit index. It was still
  % advertising the original 11-lesson ordering long after the unit was
  % consolidated, which is exactly the sort of thing nobody re-reads.
  {\fontsize{12pt}{16pt}\selectfont\color{SpaceMid}
    Ten sections --- one for each lesson:}

  \vspace{0.6cm}
  {\fontsize{11pt}{15.5pt}\selectfont\color{Navy}
    \textbf{1}\ Earth, Moon \& Sun \quad\textbullet\quad \textbf{2}\ Day, Night \& Seasons\\[0.32em]
    \textbf{3}\ The Moon --- Phases \& Tides \quad\textbullet\quad \textbf{4}\ Reading the Rocks\\[0.32em]
    \textbf{5}\ Our Solar System \quad\textbullet\quad \textbf{6}\ Space Technology \& Sustainability\\[0.32em]
    \textbf{7}\ Aboriginal \& Torres Strait Islander Astronomy}

  \vspace{0.5cm}
  {\fontsize{9.5pt}{12pt}\selectfont\color{SpaceMid}
    \textit{Section 4 is optional --- your teacher will tell you if your class is doing it.}}

  \vspace{0.9cm}
  {\fontsize{10.5pt}{14pt}\selectfont\color{Violet}
    \textbf{Above level --- extension}\\[0.32em]
    \textbf{8}\ The Search for Life \quad\textbullet\quad \textbf{9}\ Gravity \& Orbits
    \quad\textbullet\quad \textbf{10}\ Stars, Galaxies \& Starlight}

  \vspace{1.6cm}
  \textcolor{Gold}{\rule{10cm}{1.5pt}}

  \vspace{1.6cm}
  {\fontsize{11pt}{14pt}\selectfont\color{SpaceMid}
...
\newpage
% ============================================================
\section{Reading the Rocks --- Tides in Stone and the Acraman Impact}
% ============================================================
...
\subsection{Tides written in stone}
...
\newpage
% ============================================================
\section[The Search for Life --- Astrobiology \textnormal{(above level)}]{The Search for Life --- Astrobiology}
% ============================================================
...
\newpage
% ============================================================
\section[Gravity and Orbits \textnormal{(above level)}]{Gravity and Orbits}
% ============================================================
\extension{This section sits \textbf{above} the Year 7 level. The core unit
is complete without it --- work through it if you have finished the earlier
sections, or if your teacher sets it as extension.}
...
\newpage
% ============================================================
\section[Stars, Galaxies and Starlight \textnormal{(above level)}]{Stars, Galaxies and Starlight}
% ============================================================
\extension{This section sits \textbf{above} the Year 7 level. The core unit
is complete without it --- work through it if you have finished the earlier
sections, or if your teacher sets it as extension.}
