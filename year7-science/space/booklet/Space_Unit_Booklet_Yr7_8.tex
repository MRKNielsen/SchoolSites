...
Draw a simple diagram showing \textbf{Earth and the Sun}. On your diagram:
\begin{itemize}
...
\medskip
In one sentence, explain \textbf{why night happens}.
\anslines{2}
\end{scaffold}
...
% Working space for the "You do" question on deck 2 slide 18. Kept as an
% unnumbered scaffold, matching the other "Your turn" blocks, so it does
% not disturb the auto-numbered \question sequence.
\begin{scaffold}{Your turn: eclipses and phases}
A \textbf{lunar eclipse} is happening tonight. A \textbf{solar eclipse} happened two weeks ago.

\medskip
\textbf{(a)} What phase is the Moon in during the \textbf{lunar} eclipse?
\anslines{1}

\medskip
\textbf{(b)} What phase was the Moon in during the \textbf{solar} eclipse?
\anslines{1}

\medskip
\textbf{(c)} Explain why the two eclipses \textbf{cannot} happen on the same night. Refer to where the Moon has to be in each case.
\anslines{5}
\end{scaffold}
